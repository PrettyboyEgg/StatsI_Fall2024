...
\noindent That's great, you saved your table in a new file in the same folder as your .tex and .R files. Now, let's read in our saved table using \texttt{\textbackslash input\{regression\_output1.tex\}}, which will result in:
